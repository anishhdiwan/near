...
"""
This script retargets the skeleton motions saved in the .npy format to match the Adversarial Motion Priors (AMP) skeleton
The generated .npy files can then be directly used for training with the AMP skeleton in Isaacgym

Based on the retarget_motion.py script
"""
...
def main(retarget_data_path, data_path, data_dir, visualise_src_tgt, visualise):
    ...
    for idx, source_file_name in enumerate(motion_files):
        ...
        # run retargeting
        target_motion_main = source_motion.retarget_to_by_tpose(
        joint_mapping=retarget_data["joint_mapping"],
        ...
        motion_frames = [   
        [
            (125,150), (165,185), (198,215), (230,245), (260,278), (295,312), (330,345), (360,375),
            (395,410), (430,445), (465,480), (500,515), (531,546), (570,585), (605,620), (637,655),
            (670,688), (710,725), (743,760), (780,795), (813,830), (850,870)
        ],

        [
            (90,115), (135,150), (165,185), (200,220), (240,255), (275,290), (310,325), (340,355), (370,390),
            (410,425), (440,460), (472,490), (507,522), (540,560), (573,590), (605,620), (633,648), (665,680), 
            (691,725), (735,753), (773,790), (810,825)
        ]
